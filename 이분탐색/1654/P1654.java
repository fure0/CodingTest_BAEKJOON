...
public class P1654 {
    public static void main(String[] args) throws IOException {
        ...
        // 반드시 max에서 +1 값이어야 한다. (mid가 0이되는것을 방지 하기 위해)
        max++;
        ...
        // UpperBound로 얻어진 값(min)에 -1이 최대 길이가 된다. (개수가 중복이 될 떄 최대 길이를 찾아야 한다는 것이다. 쉽게 말해 Upper Bound를 통해 얻어진 값에서 -1을 해주면 최대 길이가 된다.)
